...
🔥 **高频主题：** 扩散模型 ×137 · 文生图 ×38 · 对齐/RLHF ×24 · 多模态 ×22 · 图像编辑 ×21
...
**[Scale Space Diffusion：把尺度空间塞进扩散过程](scale_space_diffusion.md)**
...
**[Stepwise-Flow-GRPO：给流匹配模型的去噪步逐步分配信用](stepwise_credit_assignment_for_grpo_on_flow-matching_models.md)**
