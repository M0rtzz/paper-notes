...
description: >-
  [CVPR 2026][视频理解][多智能体协作] VideoChat-M1 提出协作策略规划（CPP）范式，让多个异构 VLM agent 动态生成、执行和通信工具调用策略，并通过多智能体强化学习（MARL）联合优化，在 8 个 benchmark 上达到 SOTA，LongVideoBench 上超 GPT-4o 15.6%。
tags:
  - CVPR 2026
  - 视频理解
  - 多智能体协作
