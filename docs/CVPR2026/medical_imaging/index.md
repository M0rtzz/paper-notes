...
🔥 **高频主题：** 医学影像 ×84 · 语义分割 ×37 · 多模态 ×25 · 推理 ×12 · 扩散模型 ×12
...
**[CROWn: 抗混叠下采样与相位校准融合的统一 3D 医学分割框架](crown_a_unified_framework_for_anti-aliased_downsampling_and_phase-calibrated_fus.md)**
...
**[SPECTRE：面向体积 CT Transformer 的自监督与跨模态预训练](scaling_self-supervised_and_cross-modal_pretraining_for_volumetric_ct_transforme.md)**
