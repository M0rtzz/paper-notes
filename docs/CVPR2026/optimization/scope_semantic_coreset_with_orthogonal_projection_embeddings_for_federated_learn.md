...
2. **多样性分数 DS**:
	- 功能：判断一个样本是否仅仅是“标准样本的重复版本”，还是带有超出类别原型的额外结构信息。
...
7. **阶段二：Dynamic Balancing**:
	- 功能：在保证边界和尾类不被破坏的前提下，压缩头部类内部的重复样本。
