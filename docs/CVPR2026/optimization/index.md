...
item_list:
  ...
  - u: "dp-fedadamw_an_efficient_optimizer_for_differentially_private_federated_large_mo/"
  ...
  - u: "fedsdr_federated_graph_learning_with_structural_noise_detection_and_reconstructi/"
    t: "FedSDR: Federated Graph Learning with Structural Noise Detection and Reconstruction"
  - u: "fedsst_rethinking_fair_federated_graph_learning_under_structural_shift/"
    t: "FedSST: Rethinking Fair Federated Graph Learning under Structural Shift"
  ...
  - u: "hypernas_enhancing_architecture_representation_for_nas_predictor_via_hypernetwor/"
    t: "HyperNAS: Enhancing Architecture Representation for NAS Predictor via Hypernetwork"
  - u: "intrain_intrinsic_trainability_for_zero-cost_neural_architecture_search/"
    t: "InTrain: Intrinsic Trainability for Zero-Cost Neural Architecture Search"
...
🔥 **高频主题：** 联邦学习 ×16 · 扩散模型 ×2 · 个性化生成 ×2 · 对抗鲁棒 ×2
