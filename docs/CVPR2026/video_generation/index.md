---
title: >-
  CVPR2026 视频生成论文汇总 · 180篇论文解读
description: >-
  180篇CVPR2026的视频生成方向论文解读，涵盖视频生成、扩散模型、多模态、压缩/编码、语音、对齐/RLHF等方向。覆盖该方向前沿研究进展与技术创新，每篇含一句话总结、核心思想、方法详解、实验结果与局限性分析，5分钟读懂一篇论文核心思想。
tags:
  - "CVPR2026"
  - "视频生成"
  - "论文解读"
...
🔥 **高频主题：** 视频生成 ×78 · 扩散模型 ×33 · 多模态 ×9 · 压缩/编码 ×8 · 语音 ×7
