...
description: >-
  [CVPR 2026][视频生成][物理合理性视频生成] 将物理合理性视频生成(PPVG)建模为因果连接的事件序列，通过物理公式驱动的事件链推理将复杂物理现象分解为有序事件，再通过过渡感知的跨模态提示生成语义-视觉双重条件，引导视频扩散模型生成遵循因果演进的物理现象视频。 物理合理性视频生成(PPVG)旨在使生成的视频遵循真…
tags:
  - "CVPR 2026"
  - "视频生成"
  - "物理合理性视频生成"
