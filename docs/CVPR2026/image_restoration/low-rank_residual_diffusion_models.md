...
description: >-
  [CVPR 2026][图像恢复][残差扩散] LRDM 发现"近域图像恢复"（去雨/去模糊/去阴影等源域与目标域已高度相似的任务）里，退化残差天然是低秩的，于是把扩散的前向过程约束在低秩残差子空间、反向过程保持全秩，并按时间步自适应调整秩，从理论上收紧变分下界、用更少采样步换来更好的恢复保真度。 领域现状：扩散模型在图像恢…
tags:
  - "CVPR 2026"
  - "图像恢复"
  - "残差扩散"
