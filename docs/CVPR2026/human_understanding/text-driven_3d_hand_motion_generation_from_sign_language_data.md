...
description: >-
  [CVPR 2026][人体理解][手部动作生成] 本文借助大规模手语视频 + 手语词典 + LLM，自动构建了 130 万条「文本-3D手部动作」配对数据集 BOBSL3DT，并在其上训练出能由自由文本描述（手型、位置、手指/手臂运动）驱动的手部动作扩散模型 HandMDM，且对未见手势、异种手语乃至非手语手部动作都有不错的泛化。
tags:
  - "CVPR 2026"
  - "人体理解"
  - "手部动作生成"
