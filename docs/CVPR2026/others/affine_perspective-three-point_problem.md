...
description: >-
  [CVPR 2026][P3P] 把经典 P3P（三点位姿求解）放到弱透视/准透视这两种仿射相机模型下，推导出只需解一个双二次方程：的闭式最小求解器，再用一个轻量的迭代升级把仿射解"修"成精确透视解，两步迭代就能在精度上追平 SOTA 的精确 P3P 求解器，且更快。 领域现状：P3P（Perspective-Three-P…
tags:
  - "CVPR 2026"
  - "P3P"
  - "相机位姿"
