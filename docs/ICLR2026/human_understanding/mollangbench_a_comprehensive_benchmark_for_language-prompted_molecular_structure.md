...
description: >-
  [ICLR 2026][AI for Chemistry] 提出 MolLangBench，首个系统评估 AI 模型在语言提示下进行分子结构识别、编辑和生成的基准，覆盖 SMILES/图像/图三种模态，揭示 GPT-5 在识别(86.2%)和编辑(85.5%)上仍有显著差距，生成仅 43.0%，当前 AI 缺乏分子结构基础能力。
tags:
  - ICLR 2026
  - AI for Chemistry
  - 分子识别
