...
- [PersonaBooth: Personalized Text-to-Motion Generation](../../CVPR2025/image_generation/personabooth_personalized_text-to-motion_generation.md)
- [Follow the Flow: On Information Flow Across Textual Tokens in Text-to-Image Models](../../ACL2026/image_generation/follow_the_flow_on_information_flow_across_textual_tokens_in_text-to-image_model.md)
