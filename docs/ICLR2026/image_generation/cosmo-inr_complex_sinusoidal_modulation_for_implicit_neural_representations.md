...
description: >-
  [ICLR2026][图像生成][Implicit Neural Representation] 通过谐波失真分析和 Chebyshev 多项式逼近，证明奇/偶对称激活函数在后激活频谱中存在衰减，提出用复正弦项调制激活函数 (COSMO-RC) 来保留完整频谱支持，在图像重建上平均 PSNR 比最强基线高 +5.67 dB。
tags:
  - ICLR2026
  - 图像生成
