...
description: >-
  47篇ICLR2026 LLM Agent方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Livenewsbench Evaluating Llm Web Search Capabilities With Fresh News](livenewsbench_evaluating_llm_web_search_capabilities_with_fresh_news.md)**
...
**[M2-Miner Multi-Agent Enhanced Mcts For Mobile Gui Agent](m2-miner_multi-agent_enhanced_mcts_for_mobile_gui_agent.md)**
...
**[Mc-Search Evaluating And Enhancing Multimodal Agentic Search](mc-search_evaluating_and_enhancing_multimodal_agentic_search.md)**
...
**[The Controllability Trap A Governance Framework For Military Ai Systems](the_controllability_trap_a_governance_framework_for_military_ai_systems.md)**
