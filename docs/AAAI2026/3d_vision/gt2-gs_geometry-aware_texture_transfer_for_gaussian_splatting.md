...
description: >-
  [AAAI 2026][3D视觉][3D高斯溅射] 提出GT2-GS框架，通过几何感知纹理迁移损失、自适应细粒度控制模块和几何保持分支，实现高质量、视图一致的3DGS纹理迁移，在纹理保真度和场景内容保持上均优于现有3D风格迁移方法。 3D风格迁移旨在将2D参考图像的风格元素转移到3D场景，在虚拟现实、游戏等领域需求巨大…
tags:
  - "AAAI 2026"
  - "3D视觉"
  - "3D高斯溅射"
