...
description: >-
  [AAAI 2026][AI 基础理论 / 类比推理][类比推理] 从基础理论层面重新审视类比推理：首先构造反例证明布尔域上经典泛化界失效，然后提出基于参数化广义均值的统一类比推理框架，将离散分类扩展到连续回归域。 领域现状：类比推理（形如 a:b::c:d 的四元关系）是人类认知的重要机制，已在少样本学习、迁移学习、形态学…
tags:
  - "AAAI 2026"
  - "AI 基础理论 / 类比推理"
  - "类比推理"
