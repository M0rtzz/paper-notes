...
description: >-
  [AAAI 2026][LLM 其他][参数高效微调] 提出LoKI，一种基于Transformer知识存储机制理解的参数高效微调方法，通过知识向量归因（KVA）评估FFN中各知识向量的贡献度，选择低贡献向量进行层均衡的知识植入，在获得强任务性能的同时显著缓解灾难性遗忘。 领域现状： LLM在预训练中积累了丰富的世界知识…
tags:
  - "AAAI 2026"
  - "LLM 其他"
  - "参数高效微调"
