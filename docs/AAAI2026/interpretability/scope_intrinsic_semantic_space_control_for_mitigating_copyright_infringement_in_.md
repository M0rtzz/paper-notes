...
description: >-
  [AAAI 2026][可解释性][版权保护] 将LLM版权侵权缓解问题重新定义为内在语义空间控制，利用稀疏自编码器(SAE)将隐状态映射到高维稀疏空间，识别版权敏感子空间并在解码时钳制其激活，无需外部过滤器或参数更新即可有效减少版权内容复制，同时保持模型通用能力。 领域现状：LLM可能在生成过程中无意复制训练数据中的版权内…
tags:
  - "AAAI 2026"
  - "可解释性"
  - "版权保护"
