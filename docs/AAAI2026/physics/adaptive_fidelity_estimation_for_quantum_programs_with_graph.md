...
description: >-
  [AAAI 2026][物理/科学计算][量子保真度估计] 提出 QuFid 框架，将量子电路建模为有向无环图，通过控制流感知的随机游走刻画噪声传播，利用算子谱特征量化电路复杂度，实现自适应测量预算分配，在保持保真度精度的同时大幅减少测量次数。 核心矛盾 核心矛盾：领域现状：在 NISQ（含噪声中等规模量子）时代…
tags:
  - "AAAI 2026"
  - "物理/科学计算"
  - "量子保真度估计"
