...
description: >-
  [AAAI 2026 Oral][AI安全][公平聚类] 提出基于有限混合模型的公平聚类算法 FMC，通过在模型参数（而非样本级赋值）上施加公平性约束，实现参数量与样本量无关的可扩展公平聚类，支持小批量学习和分类数据，在大规模数据集上显著优于现有方法。 领域现状：公平聚类要求每个簇中敏感属性（如性别、种族）的比例与整体数据集…
tags:
  - "AAAI 2026 Oral"
  - "AI安全"
  - "公平聚类"
