...
description: >-
  [AAAI2026][目标检测][anomaly detection] 提出首个面向无监督图像异常检测的反事实解释框架，通过训练生成器将异常样本修改为被检测器视为正常的多个解纠缠反事实，从语义层面回答“如果异常是正常的，它应该是什么样子？”，提供远超传统热力图的深层解释能力。 深度学习异常检测 (AD) 在图像基准上取得了巨…
tags:
  - "AAAI2026"
  - "目标检测"
  - "anomaly detection"
