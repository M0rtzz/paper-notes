...
description: >-
  [AAAI 2026 Oral][文档版面分析] HybriDLA 首次将扩散式边框精炼与自回归查询扩展统一在一个解码层中，模拟人类由粗到细的阅读策略来处理文档版面分析，在 DocLayNet 上纯视觉模型达到 83.5% mAP，逼近多模态系统。 文档版面分析（DLA）是文档理解和信息抽取的基础任务。当前文档形式日趋复杂…
tags:
  - "AAAI 2026 Oral"
  - "文档版面分析"
  - "扩散模型"
