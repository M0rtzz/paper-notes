...
[查看全部 212 篇图像生成论文 →](image_generation/)
...
[查看全部 93 篇自动驾驶论文 →](autonomous_driving/)
...
[查看全部 74 篇语义分割论文 →](segmentation/)

---

## 📹 视频理解 (56) { #video_understanding }
...
[查看全部 56 篇视频理解论文 →](video_understanding/)
...
[查看全部 48 篇模型压缩论文 →](model_compression/)
...
[查看全部 48 篇视频生成论文 →](video_generation/)
...
[查看全部 39 篇人体理解论文 →](human_understanding/)

---

## 🏥 医学图像 (31) { #medical_imaging }
...
[查看全部 31 篇医学图像论文 →](medical_imaging/)
...
[查看全部 30 篇图像恢复论文 →](image_restoration/)

---

## 📊 LLM 评测 (27) { #llm_evaluation }
...
[查看全部 27 篇LLM 评测论文 →](llm_evaluation/)
...
[查看全部 27 篇目标检测论文 →](object_detection/)

---

## 🤖 机器人/具身智能 (26) { #robotics }
...
[查看全部 21 篇AI 安全论文 →](ai_safety/)

---

## 🎵 音频/语音 (11) { #audio_speech }
...
[查看全部 11 篇自监督/表示学习论文 →](self_supervised/)

---

## 🔬 可解释性 (10) { #interpretability }
...
## 🔍 信息检索/RAG (7) { #information_retrieval }
