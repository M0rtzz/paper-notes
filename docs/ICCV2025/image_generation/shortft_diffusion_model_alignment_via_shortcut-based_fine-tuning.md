...
description: >-
  [ICCV 2025][图像生成][扩散模型对齐] 提出 ShortFT，利用轨迹保持少步扩散模型构建去噪捷径（shortcut），将原本冗长的去噪链大幅缩短，从而实现完整的端到端奖励梯度反向传播，高效且有效地将扩散模型与奖励函数对齐。 扩散模型在文本到图像生成中表现卓越，但其最大似然训练目标与下游目标（美学、安全、文图一致…
tags:
  - "ICCV 2025"
  - "图像生成"
  - "扩散模型对齐"
