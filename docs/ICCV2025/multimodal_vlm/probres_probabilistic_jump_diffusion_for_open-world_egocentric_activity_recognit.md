...
description: >-
  [ICCV 2025][多模态VLM][开放世界活动识别] 提出 ProbRes 框架，通过基于跳跃扩散的概率残差搜索策略，结合 ConceptNet 常识先验与 VLM 似然估计，在开放世界第一人称活动识别中高效导航大规模搜索空间，大幅减少 VLM 查询次数的同时提升识别准确率。 开放世界第一人称活动识别要求模型从庞大的、…
tags:
  - "ICCV 2025"
  - "多模态VLM"
  - "开放世界活动识别"
