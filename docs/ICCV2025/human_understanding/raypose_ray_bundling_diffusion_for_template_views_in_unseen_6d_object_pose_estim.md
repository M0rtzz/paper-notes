...
description: >-
  [人体理解] 将未见物体6D位姿估计重新建模为射线对齐问题，提出物体中心的射线参数化方案，运用扩散变换器从多个已知位姿模板中推断查询图像的6D位姿。 6D物体位姿估计在机器人抓取、AR/VR、自动驾驶等应用中至关重要。现有方法面临两个核心问题： 模板匹配式方法的局限：传统方法先检索最匹配模板再对齐，但检索失败直接导致位姿不准…
tags:
  - "人体理解"
---
