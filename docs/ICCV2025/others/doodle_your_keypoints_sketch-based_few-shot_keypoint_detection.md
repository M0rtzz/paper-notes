...
description: >-
  [ICCV 2025][关键点检测] 提出首个基于草图的跨模态少样本关键点检测框架，利用原型网络、网格定位器、原型域适应和去风格化网络，仅需少量带标注草图即可在真实照片中检测新类别的新关键点。 关键点检测是计算机视觉中的基础问题，广泛应用于姿态估计和地标检测。现有方法面临以下局限： - 依赖大量标注：热力图回归和直接回归方法…
tags:
  - "ICCV 2025"
  - "关键点检测"
  - "少样本学习"
