...
description: >-
  [ICCV 2025][自回归生成] 首次将自回归（AR）模型引入多视角图像生成任务，通过逐视角生成利用所有前序视角信息来增强远距离视角间的一致性，同时设计了统一的多模态条件注入架构和Shuffle Views数据增强策略，使单一模型可同时处理文本/图像/几何形状条件。 现有多视角图像生成方法主要基于扩散模型（如MVDrea…
tags:
  - "ICCV 2025"
  - "自回归生成"
  - "多视角一致性"
