...
**非平稳性**：低层策略持续更新，导致高层过去经验中的子目标失效，HIRO 等方法通过 hindsight relabeling 缓解但效率有限
**子目标空间过大**：HRAC、HIGL 等通过约束子目标空间改善，但难以扩展到复杂环境
**缺乏不确定性建模**：传统 actor-critic 高层策略无法量化子目标预测的置信度，难以在探索与利用间取得平衡
