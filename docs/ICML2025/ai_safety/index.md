...
**[An Attack to Break Permutation-Based Private Inference Schemes for LLMs](an_attack_to_break_permutation-based_private_third-party_inference_schemes_for_l.md)**
