...
**本文要解决什么？** 如何在 GWAS 的全似然框架下高效训练大规模灵活的神经网络模型，使其能充分利用日益丰富的功能基因组特征。
...
**核心 idea 一句话**：利用 LD 矩阵的带状结构进行分块近似，将分块作为 mini-batch，结合迭代线性代数方法高效计算全似然及其梯度，从而首次实现在 GWAS 数据上训练大规模深度神经网络。
