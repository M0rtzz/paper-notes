...
description: >-
  [ICML 2025][医学图像][ECG预训练] MELP 提出了一种多尺度 ECG-语言预训练模型，通过 Token/Beat/Rhythm 三个层次的跨模态监督信号，结合心脏学专业语言模型预训练，在零样本分类、线性探测和迁移学习中全面超越现有 ECG 自监督和多模态方法。 心电图（ECG）是心血管疾病诊断的核心工具…
tags:
  - "ICML 2025"
  - "医学图像"
  - "ECG预训练"
