...
description: >-
  [ICML2025][可解释性][决策树] 提出将决策树转换为最小析取范式(DNF)表示，消除"预测等价性"问题，统一表示具有相同决策边界的不同决策树，进而改善变量重要性度量、缺失数据鲁棒性和特征获取成本优化。 决策树因其清晰的决策结构广泛用于可解释机器学习，但存在一个容易被忽视的核心问题——预测等价性(Predictive…
tags:
  - "ICML2025"
  - "可解释性"
  - "决策树"
