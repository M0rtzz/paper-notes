...
description: >-
  [ICML 2025][可解释性][剪枝] 提出 PromptQuine 框架，通过进化搜索对 ICL prompt 进行 token 级剪枝，发现将清晰示例剪成看似"乱码"的子序列反而能提升 LLM 性能，且匹配或超越 SOTA prompt 优化方法。 传统观点认为，精心设计的指令和示例是 ICL 性能的关键。然而…
tags:
  - "ICML 2025"
  - "可解释性"
  - "剪枝"
