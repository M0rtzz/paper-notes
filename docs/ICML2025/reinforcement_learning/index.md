...
tags:
  ...
  - "少样本学习"
item_list:
  - u: "a_theoretical_study_of_hyper_self-attention_through_the_lens_of_interactions_rep/"
    t: "A Theoretical Study of (Hyper) Self-Attention through the Lens of Interactions: Representation, Training, Generalization"
  - u: "action-dependent_optimality-preserving_reward_shaping/"
    t: "Action-Dependent Optimality-Preserving Reward Shaping (ADOPS)"
  - u: "actor-critics_can_achieve_optimal_sample_efficiency/"
    t: "Actor-Critics Can Achieve Optimal Sample Efficiency"
  - u: "adversarial_cooperative_rationalization_the_risk_of_spurious_correlations_in_eve/"
    t: "Adversarial Cooperative Rationalization: The Risk of Spurious Correlations in Even Clean Datasets"
  - u: "automatic_reward_shaping_from_confounded_offline_data/"
    t: "Automatic Reward Shaping from Confounded Offline Data"
  - u: "beaver_building_environments_with_assessable_variation_for_evaluating_multi-obje/"
    t: "BEAVER: Building Environments with Assessable Variation for Evaluating Multi-Objective Reinforcement Learning"
  - u: "benchmarking_quantum_reinforcement_learning/"
    t: "Benchmarking Quantum Reinforcement Learning"
  - u: "beyond_the_rainbow_high_performance_deep_reinforcement_learning_on_a_desktop_pc/"
    t: "Beyond The Rainbow: High Performance Deep Reinforcement Learning on a Desktop PC"
  - u: "brite_bootstrapping_reinforced_thinking_process_to_enhance_language_model_reason/"
    t: "BRITE: Bootstrapping Reinforced Thinking Process to Enhance Language Model Reasoning"
  - u: "conceptual_belief-informed_reinforcement_learning/"
    t: "Conceptual Belief-Informed Reinforcement Learning"
  - u: "continual_reinforcement_learning_by_planning_with_online_world_models/"
    t: "Continual Reinforcement Learning by Planning with Online World Models"
  - u: "controlling_underestimation_bias_in_constrained_reinforcement_learning_for_safe_/"
    t: "Controlling Underestimation Bias in Constrained Reinforcement Learning for Safe Exploration"
  - u: "counterfactual_effect_decomposition_in_multi-agent_sequential_decision_making/"
    t: "Counterfactual Effect Decomposition in Multi-Agent Sequential Decision Making"
  - u: "craftium_bridging_flexibility_and_efficiency_for_rich_3d_single-_and_multi-agent/"
    t: "Craftium: An Extensible Framework for Creating Reinforcement Learning Environments"
  - u: "decoding_rewards_in_competitive_games_inverse_game_theory_with_entropy_regulariz/"
    t: "Decoding Rewards in Competitive Games: Inverse Game Theory with Entropy Regularization"
  - u: "demystifying_the_paradox_of_importance_sampling_with_an_estimated_history-depend/"
    t: "Demystifying the Paradox of Importance Sampling with an Estimated History-Dependent Behavior Policy in Off-Policy Evaluation"
  - u: "divide_and_conquer_grounding_llms_as_efficient_decision-making_agents_via_offlin/"
    t: "Divide and Conquer: Grounding LLMs as Efficient Decision-Making Agents via Offline Hierarchical Reinforcement Learning"
  - u: "diving_into_self-evolving_training_for_multimodal_reasoning/"
    t: "Diving into Self-Evolving Training for Multimodal Reasoning"
  - u: "embedding_safety_into_rl_a_new_take_on_trust_region_methods/"
    t: "Embedding Safety into RL: A New Take on Trust Region Methods"
  - u: "enhancing_cooperative_multi-agent_reinforcement_learning_with_state_modelling_an/"
    t: "Enhancing Cooperative Multi-Agent Reinforcement Learning with State Modelling and Adversarial Exploration"
  - u: "enhancing_decision-making_of_large_language_models_via_actor-critic/"
    t: "Enhancing Decision-Making of Large Language Models via Actor-Critic"
  - u: "ergodic_generative_flows/"
    t: "Ergodic Generative Flows"
  - u: "exploring_large_action_sets_with_hyperspherical_embeddings_using_von_mises-fishe/"
    t: "Exploring Large Action Sets with Hyperspherical Embeddings using von Mises-Fisher Sampling"
  - u: "extreme_value_policy_optimization_for_safe_reinforcement_learning/"
    t: "Extreme Value Policy Optimization for Safe Reinforcement Learning"
  - u: "fast_and_robust_task_sampling_with_posterior_and_diversity_synergies_for_adaptiv/"
    t: "Fast and Robust: Task Sampling with Posterior and Diversity Synergies for Adaptive Decision-Makers in Randomized Environments"
  - u: "graph-supported_dynamic_algorithm_configuration_for_multi-objective_combinatoria/"
    t: "Graph-Supported Dynamic Algorithm Configuration for Multi-Objective Combinatorial Optimization"
  - u: "heterogeneous_data_game_characterizing_the_model_competition_across_multiple_dat/"
    t: "Heterogeneous Data Game: Characterizing the Model Competition Across Multiple Data Sources"
  - u: "hierarchical_reinforcement_learning_with_targeted_causal_interventions/"
    t: "Hierarchical Reinforcement Learning with Targeted Causal Interventions"
  - u: "kea_keeping_exploration_alive_by_proactively_coordinating_exploration_strategies/"
    t: "KEA: Keeping Exploration Alive by Proactively Coordinating Exploration Strategies"
  - u: "learning_mean_field_control_on_sparse_graphs/"
    t: "Learning Mean Field Control on Sparse Graphs"
item_total: 70
---
...
📌 **同领域跨会议浏览：** [🧪 ICML2026 (95)](../../ICML2026/reinforcement_learning/index.md) · [💬 ACL2026 (44)](../../ACL2026/reinforcement_learning/index.md) · [📷 CVPR2026 (30)](../../CVPR2026/reinforcement_learning/index.md) · [🔬 ICLR2026 (126)](../../ICLR2026/reinforcement_learning/index.md) · [🤖 AAAI2026 (58)](../../AAAI2026/reinforcement_learning/index.md) · [🧠 NeurIPS2025 (143)](../../NeurIPS2025/reinforcement_learning/index.md)
