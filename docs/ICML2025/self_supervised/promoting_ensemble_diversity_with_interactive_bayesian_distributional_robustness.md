---
title: >-
  [论文解读] Promoting Ensemble Diversity with Interactive Bayesian Distributional Robustness for Fine-tuning Foundation Models
description: >-
  [ICML2025][自监督学习][贝叶斯推断] 提出 IBDR 框架，在贝叶斯推断中建模粒子间交互以促进集成多样性，结合 Wasserstein 分布鲁棒优化提供理论保证，在 VTAB-1K 和常识推理任务上显著优于现有方法。
tags:
  - ICML2025
  - 自监督学习
  - 贝叶斯推断
