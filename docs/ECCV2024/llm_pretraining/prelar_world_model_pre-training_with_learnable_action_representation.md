...
description: >-
  [ECCV 2024][预训练][世界模型预训练] 本文提出PreLAR，在无动作标签的视频上进行世界模型预训练时，通过从相邻帧编码隐式动作表示并设计动作-状态一致性损失来弥合无动作预训练与有动作微调之间的差距，显著提升了下游视觉控制任务的样本效率。 领域现状：基于模型的强化学习(Model-Based RL…
tags:
  - "ECCV 2024"
  - "预训练"
  - "世界模型预训练"
