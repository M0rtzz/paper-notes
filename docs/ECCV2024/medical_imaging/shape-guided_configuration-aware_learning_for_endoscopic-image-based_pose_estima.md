...
description: >-
  [ECCV 2024][医学图像][柔性机器人] 利用柔性机器人的3D形状先验引导图像特征学习，通过部件级几何表示提取和动态形状变形机制，实现了高精度的内窥镜图像柔性机器人位姿估计，在外部朝向和内部弯曲角度估计上显著超越了关键点、骨架和直接回归等基线方法。 领域现状：柔性机器人在腔内手术（如胃肠道内窥镜手术）中日益重要…
tags:
  - "ECCV 2024"
  - "医学图像"
  - "柔性机器人"
