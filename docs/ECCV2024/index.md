...
[查看全部 117 篇图像生成论文 →](image_generation/)
...
[查看全部 53 篇自动驾驶论文 →](autonomous_driving/)
...
[查看全部 51 篇人体理解论文 →](human_understanding/)
...
[查看全部 47 篇多模态 VLM论文 →](multimodal_vlm/)
...
[查看全部 47 篇视频理解论文 →](video_understanding/)
...
[查看全部 29 篇目标检测论文 →](object_detection/)

---

## 🖼️ 图像恢复 (28) { #image_restoration }
...
[查看全部 28 篇图像恢复论文 →](image_restoration/)

---

## 🏥 医学图像 (27) { #medical_imaging }
...
[查看全部 27 篇医学图像论文 →](medical_imaging/)
...
[查看全部 24 篇模型压缩论文 →](model_compression/)
...
[查看全部 19 篇LLM 评测论文 →](llm_evaluation/)
...
[查看全部 15 篇自监督/表示学习论文 →](self_supervised/)
...
[查看全部 14 篇视频生成论文 →](video_generation/)
