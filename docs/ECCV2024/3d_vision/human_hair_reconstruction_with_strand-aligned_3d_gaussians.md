...
**本文要解决什么？** 设计一种将发丝多段线和 3D 高斯基元统一的双表示方案，使得发丝重建既能利用可微渲染的光度学约束来提升几何精度，又能输出图形引擎可用的结构化发丝。
...
**核心idea一句话**：将高斯基元绑定到发丝线段上形成 strand-aligned Gaussians，既保留发丝的结构化表示又获得可微渲染能力，实现两全其美。
