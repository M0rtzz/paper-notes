...
description: >-
  [ECCV 2024][3D视觉][人体网格恢复] 提出一种从全局特征到像素级特征的两阶段回归框架，通过自适应2D关键点引导的局部编码模块捕获细粒度身体部位信息，并引入动态匹配策略改善视觉-网格对齐，在Human3.6M和3DPW上取得SOTA。 领域现状：人体网格恢复（HMR）是从单张图像中重建3D人体网格的任务…
tags:
  - "ECCV 2024"
  - "3D视觉"
  - "人体网格恢复"
