...
**本文要解决什么？** (1) 如何利用大规模预训练扩散模型的先验知识提升几何估计的泛化能力和细节保真度？(2) 如何在单一模型中联合估计深度和法线并保持几何一致性？(3) 如何解决混合场景训练导致的布局歧义？
...
**核心idea一句话**：释放Stable Diffusion的扩散先验用于3D几何估计，通过几何切换器和场景分布解耦实现高保真的联合深度-法线零样本预测。
