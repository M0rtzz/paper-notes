...
**本文要解决什么？** (1) 如何从特征分布的统计角度来增强知识蒸馏中的对抗鲁棒性迁移？(2) 特征方差差距与对抗鲁棒性之间的定量关系是什么？(3) 如何同时保持自然图像上的高精度？
...
**核心idea一句话**：通过将 student 的特征协方差向 teacher 的特征协方差对齐，减小对抗/干净样本之间的方差差距，从而隐式提升 student 的对抗鲁棒性。
