...
**本文要解决什么？** (1) 如何让规划器理解人类驾驶决策背后的风险规避动机；(2) 如何让规划器了解自身动作的物理后果；(3) 如何在训练中更好地利用困难样本来提升泛化能力。
...
**核心idea一句话**：在模仿学习的基础上，添加TTC预测分支学习驾驶动机中的风险因素，并通过规划轨迹的TTC自一致性检验来理解动作后果、挖掘困难样本。
