...
description: >-
  [ECCV 2024][语义分割][图像分割] 提出 CoReS（Chains of Reasoning and Segmenting），一种双链结构的多模态思维链框架，通过推理链和分割链的层次化协作，结合 in-context 引导策略，实现对复杂推理文本中目标物体的渐进式精确分割，在 ReasonSeg 数据集上超越 LISA 6.5%。
tags:
  - "ECCV 2024"
  - "语义分割"
  - "图像分割"
...
- [\[CVPR 2026\] Fast Reasoning Segmentation for Images and Videos](../../CVPR2026/segmentation/fast_reasoning_segmentation_for_images_and_videos.md)
