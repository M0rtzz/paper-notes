...
description: >-
  [ECCV 2024][机器人][抓取动作生成] 提出 GraspXL，一个基于强化学习的抓取动作生成框架，仅用58个物体训练即可泛化到50万+未见物体，同时支持多运动目标（抓取区域、朝向、手腕旋转、手部位置）控制和多种灵巧手平台。 人手具有非凡的灵巧性——能够抓取任意形状的物体，精确到特定部位，从特定方向接近…
tags:
  - "ECCV 2024"
  - "机器人"
  - "抓取动作生成"
