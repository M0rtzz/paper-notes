...
**本文要解决什么？** (1) 如何让模型具有波长感知能力，从而适应不同相机的光谱分布？(2) 如何有效利用 MSFA 的空间模式信息指导去马赛克？(3) 如何在单一数据集上训练出跨相机泛化的模型？
...
**核心idea一句话**：将波长信息作为嵌入注入多头自注意力的计算中，赋予模型跨相机的波长适应能力，同时用 MSFA 模式引导注意力聚焦高质量采样区域。
