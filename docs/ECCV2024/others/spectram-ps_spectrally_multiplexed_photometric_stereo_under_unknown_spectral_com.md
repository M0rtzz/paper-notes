...
**本文要解决什么？** (1) 如何在光源光谱组成完全未知的条件下进行光谱复用PS？(2) 如何设计一种对光谱串扰鲁棒的法线估计方法？(3) 如何处理非朗伯（non-Lambertian）表面的复杂反射？
...
**核心idea一句话**：用数据驱动的深度学习方法直接从单张光谱复用RGB图像预测表面法线，无需知道光源光谱、相机响应或材质光谱反射率。
