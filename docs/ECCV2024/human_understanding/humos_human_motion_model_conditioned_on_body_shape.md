...
description: >-
  [ECCV 2024][人体理解][人体运动生成] 提出 HUMOS，一种基于体型条件化的人体运动生成模型，通过循环一致性损失和可微分的直觉物理/动态稳定性约束，在无配对训练数据的情况下学习体型与运动之间的相关性，生成物理可信且动态稳定的人体运动。 领域现状：人体运动生成在游戏、AR/VR、机器人仿真中至关重要…
tags:
  - "ECCV 2024"
  - "人体理解"
  - "人体运动生成"
