...
**本文要解决什么？**（1）设计专门针对红外图像频域特性的 SR 框架；（2）利用多尺度多方向的频域分解精确增强红外图像的关键高频信息；（3）引入语义理解能力来指导红外图像的超分辨率过程。
...
**核心idea一句话**：用 Contourlet 变换的多尺度多方向残差来精准增强红外图像的高频细节，并通过视觉语言模型的提示学习提供语义级别的红外特征优化指导。
