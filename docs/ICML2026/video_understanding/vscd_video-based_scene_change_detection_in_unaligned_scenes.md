...
description: >-
  [ICML 2026][视频理解][场景变化检测] 本文引入 VSCD 任务——通过查询中心的多参考模型，在无约束相机运动和强烈视点失配条件下，利用时间一致性、补丁级对应和置信度加权融合，逐像素检测两段不同时间记录的同一环境视频中的物体级变化。 领域现状：变化检测是 CV 经典问题，现有方法分两类——基于图像（RSCD、SC…
tags:
  - "ICML 2026"
  - "视频理解"
  - "场景变化检测"
