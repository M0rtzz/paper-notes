...
📌 **同领域跨会议浏览：** [📷 CVPR2026 (145)](../../CVPR2026/others/index.md) · [💬 ACL2026 (1)](../../ACL2026/others/index.md) · [🔬 ICLR2026 (71)](../../ICLR2026/others/index.md) · [🤖 AAAI2026 (117)](../../AAAI2026/others/index.md) · [🧠 NeurIPS2025 (121)](../../NeurIPS2025/others/index.md) · [📹 ICCV2025 (33)](../../ICCV2025/others/index.md)
...
**[通过分布式鲁棒逐节点回归的变量聚类](variable_clustering_via_distributionally_robust_nodewise_regression.md)**

:   利用分布式鲁棒优化框架将逐节点回归的参数调优问题转化为带谱范数正则化的凸优化问题——实现无参数聚类方法，在模拟、人脸和金融数据上显著超越 Lasso 稀疏聚类。

**[Vision Transformer 微调中的非光滑分量优势](vision_transformer_finetuning_benefits_from_non-smooth_components.md)**
