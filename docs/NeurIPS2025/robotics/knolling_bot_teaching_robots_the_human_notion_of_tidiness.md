...
description: >-
  [NeurIPS 2025][机器人][物体整理] 提出基于 Transformer + GMM 的自监督学习框架，将桌面物体整理（knolling）类比为 NLP 序列预测任务，从 240 万组自动生成的整理示范中学习通用"整洁度"表示，支持任意数量物体和基于用户偏好的多样化整理方案，并在真实机械臂上部署验证。
tags:
  - NeurIPS 2025
  - 机器人
  - knolling
