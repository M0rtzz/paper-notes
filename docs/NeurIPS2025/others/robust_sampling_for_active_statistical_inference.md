...
description: >-
  [NeurIPS 2025][主动推断] 提出基于预算保持路径的鲁棒采样策略，通过在均匀采样和主动采样之间最优插值，确保估计器的方差永远不比两者中任何一个更差，解决了主动统计推断中不确定性估计不准确导致性能恶化的问题。 现有痛点 现有痛点：领域现状：主动统计推断利用AI模型的不确定性评分优先采集高不确定性样本的标签来提高估计…
tags:
  - "NeurIPS 2025"
  - "主动推断"
  - "鲁棒采样"
