...
description: >-
  [NeurIPS 2025][RNN学习动力学] 从数学理论上揭示了 RNN 在闭环（agent-环境交互）与开环（监督学习）训练下呈现根本不同的学习动力学，闭环学习遵循三阶段过程，由短期策略改进与长期稳定性之间的竞争驱动。 领域现状：RNN 广泛用于神经科学建模和序列任务。现有理论工作主要分析 RNN 在开环（监督学习）设…
tags:
  - "NeurIPS 2025"
  - "RNN学习动力学"
  - "闭环学习"
