---
title: >-
  [论文解读] AcuRank: 基于不确定性感知的自适应计算列表式重排序
description: >-
  [NeurIPS 2025][信息检索] 提出AcuRank框架，利用贝叶斯TrueSkill模型对文档相关性进行概率建模，通过迭代精化不确定文档的排名估计，实现自适应计算分配，在TREC-DL和BEIR基准上以更少的重排器调用达到更优的精度-效率权衡。
tags:
  - NeurIPS 2025
  - 信息检索
  - 不确定性估计
