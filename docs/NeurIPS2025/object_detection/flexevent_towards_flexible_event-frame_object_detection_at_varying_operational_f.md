...
description: >-
  [NeurIPS 2025][目标检测][事件相机] 提出 FlexEvent 框架，通过自适应事件-图像融合模块 FlexFuse 和频率自适应微调机制 FlexTune，实现事件相机在不同操作频率下的灵活目标检测，在 20Hz 到 180Hz 范围内保持鲁棒性能，显著超越现有方法。 事件相机以微秒级时间分辨率和异步工作方…
tags:
  - "NeurIPS 2025"
  - "目标检测"
  - "事件相机"
