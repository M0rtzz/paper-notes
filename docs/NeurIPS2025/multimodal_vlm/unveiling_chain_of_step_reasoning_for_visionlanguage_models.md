...
description: >-
  提出Chain-of-Step (CoS)推理框架，将VLM推理链分解为结构化步骤（Name+Thought+Reflection），结合Process Reward Model提供步骤级奖励，通过迭代DPO与step-level beam search实现推理能力的系统性提升，揭示VLM推理中质量优先于长度的关键洞察。
tags:
  - NeurIPS 2025
  - 多模态
  - chain-of-step
