...
description: >-
  [NeurIPS 2025][多模态VLM][learning rate search] 提出AdaLRS，一种即插即用的在线学习率搜索算法，通过监控损失下降速度（loss velocity）来自适应调整学习率，将学习率超参搜索的成本从多次独立训练降低到单次训练，实现~50%的训练成本节省。 学习率是基础模型预训练中最关键的…
tags:
  - "NeurIPS 2025"
  - "多模态VLM"
