...
[查看全部 221 篇图像生成论文 →](image_generation/)

---

## 🎮 强化学习 (143) { #reinforcement_learning }
...
[查看全部 143 篇强化学习论文 →](reinforcement_learning/)
...
[查看全部 142 篇模型压缩论文 →](model_compression/)
...
[查看全部 139 篇多模态 VLM论文 →](multimodal_vlm/)
...
[查看全部 123 篇优化/理论论文 →](optimization/)
...
[查看全部 113 篇3D 视觉论文 →](3d_vision/)

---

## 🔒 LLM 安全 (83) { #llm_safety }
...
[查看全部 82 篇LLM 推理论文 →](llm_reasoning/)
...
[查看全部 79 篇可解释性论文 →](interpretability/)

---

## 🧬 计算生物 (75) { #computational_biology }
...
[查看全部 75 篇计算生物论文 →](computational_biology/)
...
[查看全部 75 篇医学图像论文 →](medical_imaging/)

---

## 🤖 机器人/具身智能 (75) { #robotics }
...
[查看全部 75 篇机器人/具身智能论文 →](robotics/)

---

## 🛡️ AI 安全 (73) { #ai_safety }
...
[查看全部 73 篇AI 安全论文 →](ai_safety/)

---

## ⚛️ 物理/科学计算 (55) { #physics }
...
[查看全部 55 篇物理/科学计算论文 →](physics/)

---

## 🕸️ 图学习 (54) { #graph_learning }
...
[查看全部 54 篇LLM / NLP论文 →](llm_nlp/)

---

## 📚 预训练 (51) { #llm_pretraining }
...
[查看全部 51 篇预训练论文 →](llm_pretraining/)
...
[查看全部 51 篇时间序列论文 →](time_series/)

---

## 🎵 音频/语音 (47) { #audio_speech }
...
[查看全部 47 篇音频/语音论文 →](audio_speech/)

---

## 🚗 自动驾驶 (47) { #autonomous_driving }
...
[查看全部 47 篇自动驾驶论文 →](autonomous_driving/)

---

## ✂️ 语义分割 (45) { #segmentation }
...
[查看全部 39 篇LLM Agent论文 →](llm_agent/)

---

## 📹 视频理解 (39) { #video_understanding }
...
[查看全部 39 篇视频理解论文 →](video_understanding/)

---

## 📊 LLM 评测 (38) { #llm_evaluation }
...
[查看全部 38 篇LLM 评测论文 →](llm_evaluation/)

---

## ⚖️ 对齐 / RLHF (36) { #llm_alignment }
...
[查看全部 36 篇对齐 / RLHF论文 →](llm_alignment/)

---

## 🔄 自监督/表示学习 (35) { #self_supervised }
...
[查看全部 35 篇自监督/表示学习论文 →](self_supervised/)

---

## ⚡ LLM 效率 (34) { #llm_efficiency }
...
[查看全部 34 篇LLM 效率论文 →](llm_efficiency/)
...
[查看全部 30 篇信息检索/RAG论文 →](information_retrieval/)

---

## 🖼️ 图像恢复 (26) { #image_restoration }
...
[查看全部 26 篇图像恢复论文 →](image_restoration/)

---

## 🎯 目标检测 (26) { #object_detection }
...
[查看全部 26 篇目标检测论文 →](object_detection/)
...
[查看全部 24 篇推荐系统论文 →](recommender/)

---

## 🎬 视频生成 (23) { #video_generation }
...
[查看全部 23 篇视频生成论文 →](video_generation/)

---

## 🔗 因果推理 (20) { #causal_inference }
...
[查看全部 20 篇因果推理论文 →](causal_inference/)
...
[查看全部 20 篇代码智能论文 →](code_intelligence/)
...
[查看全部 20 篇人体理解论文 →](human_understanding/)

---

## 👥 社会计算 (20) { #social_computing }
...
[查看全部 20 篇社会计算论文 →](social_computing/)

---

## 👻 幻觉检测 (17) { #hallucination }
...
[查看全部 17 篇多智能体论文 →](multi_agent/)

---

## 🩺 医疗 NLP (15) { #medical_nlp }
...
[查看全部 15 篇医疗 NLP论文 →](medical_nlp/)

---

## 🛰️ 遥感 (12) { #remote_sensing }
...
[查看全部 12 篇遥感论文 →](remote_sensing/)

---

## 🌐 多语言/翻译 (11) { #multilingual_mt }
...
[查看全部 11 篇多语言/翻译论文 →](multilingual_mt/)

---

## 🔎 AIGC 检测 (9) { #aigc_detection }
