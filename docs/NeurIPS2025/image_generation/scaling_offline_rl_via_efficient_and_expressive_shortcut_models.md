...
description: >-
  [NeurIPS 2025][图像生成][Offline RL] 提出 SORL，利用 shortcut models 的自一致性实现离线 RL 中高效一阶段训练与可变推理步数的策略优化，同时支持推理时的顺序和并行扩展。 领域现状：离线强化学习 (Offline RL) 通过固定数据集训练智能体而无需在线探索…
tags:
  - "NeurIPS 2025"
  - "图像生成"
  - "Offline RL"
...
- [\[NeurIPS 2025\] Panel-by-Panel Souls: A Performative Workflow for Expressive Faces in AI-Assisted Manga Creation](panel-by-panel_souls_a_performative_workflow_for_expressive_faces_in_ai-assisted.md)
