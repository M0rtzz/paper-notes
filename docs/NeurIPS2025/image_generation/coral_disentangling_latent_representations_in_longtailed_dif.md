...
description: >-
  [NeurIPS 2025][图像生成][长尾学习] 深入分析长尾数据下扩散模型尾类生成退化的根因——U-Net 瓶颈层的表示纠缠，提出 CORAL 在瓶颈层施加监督对比正则化，CIFAR10-LT 上 FID 从 6.17 降至 5.32，ImageNet-LT 上 FID 从 17.08 降至 16.11 并全面超越 CBDM 和 T2H。
tags:
  - NeurIPS 2025
  - 图像生成
  - 长尾学习
