...
**本文要解决什么**：如何在不训练任何 draft 模型的条件下，构建有效的 cascade speculative decoding，并设计自适应调度使之真正超越单级方法？
...
**核心idea一句话**：将 self-speculative decoding 的不同压缩层次重新解释为 cascade 中的多级 draft 模型，用基于接受率 EMA 和延迟预测的动态树搜索来自适应调度整个层级。
