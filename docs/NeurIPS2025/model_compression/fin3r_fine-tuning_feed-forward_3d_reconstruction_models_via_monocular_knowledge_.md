...
description: >-
  [NeurIPS 2025][模型压缩][3D重建] 提出 Fin3R，通过冻结 decoder 并用带重归一化的 LoRA 适配器对 encoder 进行单目知识蒸馏微调，以统一且轻量的方式提升 DUSt3R/MASt3R/CUT3R/VGGT 等前馈式 3D 重建模型的几何精度和鲁棒性。 前馈式 3D 重建兴起：DUSt…
tags:
  - "NeurIPS 2025"
  - "模型压缩"
  - "3D重建"
