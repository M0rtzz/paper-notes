...
## 研究背景与动机
**领域现状**：LLM 使用静态 BPE 分词器，词表在通用语料上优化，面对代码/生物医学/多语言等领域分词效率差 2-3 倍
**现有痛点**：简单扩大词表收益递减且可能损害性能；为每个领域维护独立分词器不可扩展
**核心 idea**：推理时用 LZW 算法在线合并高频共现 Token 为 hypertoken，动态嵌入层计算新 Token 的表示
