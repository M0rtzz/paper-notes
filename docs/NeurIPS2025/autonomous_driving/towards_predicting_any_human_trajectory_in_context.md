...
description: >-
  [NeurIPS 2025][自动驾驶][行人轨迹预测] 提出 TrajICL，一种基于上下文学习（ICL）的行人轨迹预测框架，通过时空相似性示例选择和预测引导示例选择，在不微调的情况下实现跨场景自适应轨迹预测，性能甚至超越微调方法。 行人轨迹预测是自动驾驶、机器人导航和监控系统的关键任务。现有方法虽然在特定环境中表现优异…
tags:
  - "NeurIPS 2025"
  - "自动驾驶"
  - "行人轨迹预测"
