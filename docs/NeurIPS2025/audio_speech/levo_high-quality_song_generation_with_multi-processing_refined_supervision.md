...
description: >-
  [音频/语音] LeVo 提出一种基于语言模型的歌曲生成框架，通过并行预测混合 token 和双轨 token 来同时优化人声-伴奏和谐度与音质，并引入基于 DPO 的多偏好对齐方法提升音乐性和指令跟随能力，在学术方法中全面领先且接近工业系统水平。 歌曲生成是 AIGC 领域中极具挑战性的任务，需要同时生成高质量的人声和伴奏…
tags:
  - "音频/语音"
---
