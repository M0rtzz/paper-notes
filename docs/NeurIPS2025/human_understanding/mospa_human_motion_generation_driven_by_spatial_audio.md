...
description: >-
  [NeurIPS 2025][运动生成][空间音频] 首次定义空间音频驱动人体运动生成任务，构建 SAM 数据集（9+ 小时、27 种场景、12 名受试者的双耳音频-运动配对），提出 MOSPA 扩散模型融合 MFCC/tempogram/RMS 音频特征与声源位置/运动风格条件，FID 7.98 大幅领先 EDGE（14.0）等基线。
tags:
  - NeurIPS 2025
  - 运动生成
  - 空间音频
