...
description: >-
  [NeurIPS 2025 Oral][医学图像][texture bias] 通过系统化的特征抑制框架（而非冲突选择实验）重新评估 CNN 的特征依赖性，发现 CNN 并非天然偏向纹理，而是主要依赖局部形状特征；且不同领域（CV/MI/RS）的特征依赖模式显著不同。 领域现状：Geirhos et al. 2019 年的…
tags:
  - "NeurIPS 2025 Oral"
  - "医学图像"
  - "texture bias"
