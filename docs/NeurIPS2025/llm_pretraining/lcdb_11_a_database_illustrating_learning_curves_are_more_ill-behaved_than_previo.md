...
description: >-
  [NeurIPS 2025][预训练][learning curves] 构建了大规模高分辨率学习曲线数据库 LCDB 1.1，证明样本学习曲线的"病态行为"（非单调、非凸）比此前认为的普遍两倍，约 15% 的曲线显著不良，且特征缩放难以修复。 样本学习曲线（sample-wise learning curve）描绘模型性能…
tags:
  - "NeurIPS 2025"
  - "预训练"
  - "learning curves"
