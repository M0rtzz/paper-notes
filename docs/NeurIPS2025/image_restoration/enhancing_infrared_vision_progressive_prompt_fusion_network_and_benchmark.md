...
description: >-
  [NeurIPS 2025][图像恢复][热红外图像增强] 针对热红外(TIR)图像中低对比度、模糊、噪声等多种退化耦合的问题，提出基于双提示融合的渐进式网络PPFN和选择性渐进训练策略SPT，并构建首个大规模多场景TIR基准数据集HM-TIR，在复合退化场景下PSNR提升8.76%。 领域现状：热红外成像依靠探测物体热辐射…
tags:
  - "NeurIPS 2025"
  - "图像恢复"
  - "热红外图像增强"
...
- [\[CVPR 2026\] Bridging Human Evaluation to Infrared and Visible Image Fusion](../../CVPR2026/image_restoration/bridging_human_evaluation_to_infrared_and_visible_image_fusion.md)
