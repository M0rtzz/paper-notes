...
description: >-
  [NeurIPS 2025][视频理解][视频异常检测] 提出一个完全零样本、无需训练的视频异常分析框架，通过Intra-Task Reasoning（置信度门控的自我精化）和Inter-Task Chaining（从时序检测到空间定位到语义理解的级联prompt传递），在4个benchmark上全面超越先前零样本方法4-6% AUC。
tags:
  - "NeurIPS 2025"
  - "视频理解"
  - "视频异常检测"
...
- [\[CVPR 2026\] Metadata-Aware Multi-Prompt Reasoning for Zero-Shot Accident Understanding](../../CVPR2026/video_understanding/metadata-aware_multi-prompt_reasoning_for_zero-shot_accident_understanding.md)
