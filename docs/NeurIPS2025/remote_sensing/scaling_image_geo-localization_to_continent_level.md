...
description: >-
  [NeurIPS 2025][遥感][地理定位] 混合方法结合分类学习的原型和航拍图像嵌入，在覆盖西欧43.3万平方公里上实现200m内68%+、100m内59.2%的定位率，首次在大陆规模实现此精度。 现有痛点 现有痛点：领域现状：问题：视觉地理定位存在精度与规模的根本权衡。 ：痛点：分类方法可扩展但粗糙(10km)…
tags:
  - "NeurIPS 2025"
  - "遥感"
  - "地理定位"
