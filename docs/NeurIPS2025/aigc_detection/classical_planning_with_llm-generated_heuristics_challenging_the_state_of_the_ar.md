...
description: >-
  [NeurIPS 2025][AI规划][LLM代码生成] 提出让 LLM 生成域相关启发式函数的 Python 代码（而非直接生成计划），通过多次采样+训练集选优的流程，将生成的启发式注入教学级 Python 规划器 Pyperplan，在 IPC 2023 Learning Track 8 个域上以 373/720 的解题数超越了所有 C++ Fast Downward 传统启发式（最佳 324），并与 SOTA 学习型规划器持平。
tags:
  - NeurIPS 2025
  - AI规划
  - LLM代码生成
