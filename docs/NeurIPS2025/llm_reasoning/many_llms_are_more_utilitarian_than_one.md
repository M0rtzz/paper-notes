...
## 研究背景与动机
**LLM多智能体系统快速部署**：LLM-MAS已在医疗、法律等高风险领域用于协同决策，但对其集体道德推理行为缺乏研究
**个体对齐≠集体对齐**：单个模型的安全评估无法预测多个模型协作时的涌现行为——偏见放大、隐蔽协调、知识漂移等风险可能级联
**人类群体的功利主义增强已被充分验证**：社会心理学研究表明人类群体讨论后更倾向接受伤害少数人以造福多数，但LLM-MAS中是否存在类似现象未知
**道德推理的社会性被忽视**：现有LLM道德推理研究几乎只关注单智能体，忽略了群体协商、论辩在道德判断中的核心作用
**高风险场景的紧迫性**：如果临床LLM集体建议为"更大利益"牺牲个体患者，将严重违反医疗伦理且损害对AI的信任
**计算社会科学空白**：LLM被越来越多用于模拟人类推理，但忽略群体层面的道德动态限制了这些模拟的洞察力
