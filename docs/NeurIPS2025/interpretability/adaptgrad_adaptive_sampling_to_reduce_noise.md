...
description: >-
  [NeurIPS 2025][可解释性][梯度平滑] AdaptGrad通过分析SmoothGrad噪声的理论来源——超范围采样行为，提出自适应调整每个输入维度的高斯采样方差以控制额外噪声上限的方法，在几乎消除梯度噪声的同时揭示更丰富的细节特征，方法极简且可与任意梯度解释方法组合。 领域现状：梯度是深度模型可解释性的关键信息…
tags:
  - "NeurIPS 2025"
  - "可解释性"
  - "梯度平滑"
