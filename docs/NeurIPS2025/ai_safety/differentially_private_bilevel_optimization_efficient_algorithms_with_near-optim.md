...
description: >-
  [NeurIPS 2025][AI安全][双层优化] 本文系统研究差分隐私 (DP) 下的双层优化问题，在凸情形下通过指数机制和正则化指数机制给出近紧的上下界（匹配单层 DP-ERM 最优率），在非凸情形下提出二阶 DP 方法实现不依赖内层维度的 SOTA 收敛率。 领域现状：双层优化 (BLO) 在元学习、超参数优化、对抗…
tags:
  - "NeurIPS 2025"
  - "AI安全"
  - "双层优化"
