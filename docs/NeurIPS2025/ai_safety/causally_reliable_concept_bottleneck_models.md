...
- [ESC: Erasing Space Concept for Knowledge Deletion](../../CVPR2025/ai_safety/esc_erasing_space_concept_for_knowledge_deletion.md)
- [LogitDynamics: Reliable ViT Error Detection from Layerwise Logit Trajectories](../../CVPR2026/ai_safety/logitdynamics_vit_error_detection.md)
