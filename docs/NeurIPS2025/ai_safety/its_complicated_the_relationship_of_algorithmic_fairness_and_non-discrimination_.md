...
**本文要解决什么？** (1) 为计算机科学背景的学者提供EU非歧视法的入门介绍；(2) 系统分析AI法案中高风险系统的反歧视条款与算法公平性的关系；(3) 探讨标准化进程和传统非歧视法与AI法案的互动。

**切入角度**：从跨学科视角出发，逐条分析AI法案中与反歧视相关的条款（Articles 9, 10, 13, 15等），将法律文本映射到算法公平性的技术概念上。

**核心idea一句话**：EU AI法案的反歧视条款主要关注输入侧偏差检测而忽略输出侧，且作为产品安全法缺乏个人权利保护维度，需要与传统非歧视法协同工作。
