...
description: "通过敏感性引导的通道剪枝实现高效的持续测试时自适应目标检测，减少12%计算量并提升适应精度"
tags: ["测试时自适应", "目标检测", "通道剪枝", "域偏移", "效率"]
---
