...
**本文要解决什么？** (1) 从 Neural Collapse 理论统一解释 ID/OOD 特征的几何结构; (2) 设计一个高效且跨数据集、跨架构泛化的 OOD 检测器。
...
**核心idea一句话**：利用 Neural Collapse 趋势中 ID 特征向权重向量对齐+远离原点的几何特性，设计角度近邻度+范数过滤的 OOD 检测器。
