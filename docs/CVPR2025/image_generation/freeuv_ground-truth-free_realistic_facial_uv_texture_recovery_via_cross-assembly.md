...
**本文要解决什么？** 如何在完全不需要完整 UV 纹理 ground truth 的情况下，从单张人脸图像恢复高保真、结构一致的完整 UV 纹理？
...
**核心idea一句话**：分别在两个域训练互补的网络（in-the-wild 域学外观、3DMM 域学结构），推理时跨装配两者的 UV 相关模块实现 UV-to-UV 纹理生成。
