...
description: >-
  [CVPR 2025][图像生成][物体移动] ObjectMover 将图像中物体移动任务建模为序列到序列问题，通过微调视频生成模型来利用其跨帧物体一致性知识，结合游戏引擎合成的高质量数据对和多任务学习策略，实现了在复杂真实场景中的光照重整、遮挡补全和阴影/反射同步编辑。 领域现状：图像编辑中"移动物体到另一个位置"看似简…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "物体移动"
