...
description: >-
  [CVPR 2025][图像生成][人脸修复] OSDFace 提出了首个专门针对人脸修复的单步扩散模型，通过视觉表示嵌入器（VRE）从低质量人脸中提取丰富先验信息，结合面部身份损失和 GAN 引导，仅需一步推理（约 0.1 秒）即可生成高保真、自然且身份一致的人脸图像，全面超越现有 SOTA。 领域现状：人脸修复旨在从受模…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "人脸修复"
