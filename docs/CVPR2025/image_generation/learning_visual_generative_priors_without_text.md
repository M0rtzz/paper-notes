...
description: >-
  [CVPR 2025][图像生成][图像到图像生成] 提出Lumos框架，通过纯视觉的图像到图像（I2I）自监督预训练学习视觉生成先验，然后仅用1/10的文本-图像对微调即可达到甚至超越现有T2I模型的效果，并在文本无关的视觉任务（I2V、NVS）上展现出优于T2I先验的性能。 1. 领域现状：当前文本到图像（T2I）模型是…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "图像到图像生成"
