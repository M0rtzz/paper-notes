...
description: >-
  [CVPR 2025][图像生成][多属性引导] 提出 Z-Magic 框架，从条件概率理论视角重新建模多属性图像生成中的属性依赖关系，通过条件依赖梯度引导和多任务学习优化，在零样本设置下实现多属性连贯生成。 多属性引导的图像生成在个性化内容创作中需求日益增长，如时尚设计中颜色与款式的关联、人脸合成中性别与面部特征的关联…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "多属性引导"
