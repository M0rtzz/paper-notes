...
description: >-
  [CVPR 2025][图像生成][概率密度测地线] 本文证明了在扩散模型的潜在空间中可以计算基于概率密度的测地线，其中通过高概率密度区域的路径比低密度区域更"短"，并展示了该技术在视频近似性分析、无训练图像序列插值和外推中的应用。 领域现状：扩散模型（Diffusion Models）是当前最强大的图像生成模型之一…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "概率密度测地线"
