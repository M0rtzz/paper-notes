...
description: >-
  [CVPR 2025][图像生成][虚拟试穿] 首次将扩散模型应用于饰品（手镯、戒指、耳环、项链）虚拟试戴任务，提出迭代式姿态感知佩戴蒙版预测和蒙版引导注意力机制，在大姿态和大尺度差异下实现高保真的几何结构保持。 - 服装虚拟试穿已有大量研究且趋于成熟，但饰品虚拟试戴几乎未被探索，尽管有巨大的商业需求 - 饰品试戴面临三大独…
tags:
  - "CVPR 2025"
  - "图像生成"
  - "虚拟试穿"
