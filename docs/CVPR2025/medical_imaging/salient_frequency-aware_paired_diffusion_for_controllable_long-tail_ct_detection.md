...
description: >-
  [CVPR2025][医学图像][扩散模型] 提出 SALIENT，一个基于小波域扩散的掩码条件生成框架，通过频率感知的可解释优化目标和配对的病灶-掩码体积生成，实现长尾 CT 检测中可控、高效的合成数据增强与精度拯救。首次系统表征增强剂量-反应曲线。 - 长尾检测两大失效模式：(1) 患者内信号稀释——低目标体积比（TVR…
tags:
  - "CVPR2025"
  - "医学图像"
  - "扩散模型"
