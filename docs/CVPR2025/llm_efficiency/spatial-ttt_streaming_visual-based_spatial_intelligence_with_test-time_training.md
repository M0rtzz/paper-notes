...
**切入角度**：从新的技术视角或观察出发。
**核心idea一句话**：In this paper, we propose Spatial-TTT towards streaming visual-based spatial intelligence with test-time training (TTT), which adapts a subset of parameters (fast weights) to capture and organize spat
