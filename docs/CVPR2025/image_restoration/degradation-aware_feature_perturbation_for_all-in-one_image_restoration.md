...
description: >-
  [CVPR 2025][图像恢复][全能图像恢复] 本文提出DFPIR框架，通过退化类型引导的通道打乱扰动和注意力选择性掩码扰动两种机制，在编解码器之间调整特征空间以适配统一参数空间，在去噪/去雾/去雨/去模糊/低光增强五个任务上取得SOTA。 领域现状：单任务图像恢复已取得显著进展，但为每种退化单独训练模型的方式在实际应用…
tags:
  - "CVPR 2025"
  - "图像恢复"
  - "全能图像恢复"
