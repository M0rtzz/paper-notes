...
description: >-
  [CVPR 2025][LLM 其他][老电影修复] 本文提出MambaOFR框架，针对老电影特有的复合退化问题，设计退化感知prompt引导Mamba模型动态调整修复模式，配合光流引导的掩码变形对齐模块防止结构缺陷传播，并引入首个包含合成与真实数据的老电影修复benchmark数据集。 领域现状 领域现状：老电影修复旨在恢…
tags:
  - "CVPR 2025"
  - "LLM 其他"
  - "老电影修复"
