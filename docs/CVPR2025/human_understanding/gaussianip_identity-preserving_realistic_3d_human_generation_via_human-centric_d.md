...
**本文要解决什么？** (1) 如何利用 2D 人体扩散模型的先验知识高效生成身份一致的 3D 人体；(2) 如何在蒸馏后精炼纹理细节同时保持多视角 3D 一致性。
...
**核心idea一句话**：用人体中心扩散先验替代通用扩散模型、通过 HDS 分解注入身份条件实现身份一致的 3D 人体生成，再用多视角 mutual attention 精炼确保纹理 3D 一致性。
