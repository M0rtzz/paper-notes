...
description: >-
  [CVPR2025][机器人][TinyML] 在 ESP32 微控制器上部署端到端量化 CNN，仅用 23k 参数和 ToF 深度相机实现 30ms 延迟的实时自主导航。 - 现有低成本机器人的自主导航通常依赖高功耗处理器（如单板计算机运行 SLAM），成本高且功耗大 - TinyML 领域 2020-2024 年发表量年…
tags:
  - "CVPR2025"
  - "机器人"
  - "TinyML"
...
- [\[CVPR 2026\] LEAD: Minimizing Learner-Expert Asymmetry in End-to-End Driving](../../CVPR2026/robotics/lead_minimizing_learner-expert_asymmetry_in_end-to-end_driving.md)
