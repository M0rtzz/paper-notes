...
description: >-
  [CVPR 2025][机器人][hand-object interaction] 提出多层遮挡（MLO）表示学习 3D 手-物遮挡关系，并将 Objaverse 大规模 3D 物体数据整合进训练，实现首个支持灵巧双手操作 + 可泛化物体外观的手-物操作视频生成框架。 领域现状： 基于扩散模型的手-物体交互（HOI）图像生成…
tags:
  - "CVPR 2025"
  - "机器人"
