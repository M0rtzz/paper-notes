---
title: >-
  CVPR2025 多模态VLM方向 120篇论文解读
description: >-
  120篇CVPR2025 多模态VLM方向论文深度解读，每篇5分钟读懂核心思想。每篇笔记含一句话总结、背景动机、方法详解、实验数据、亮点洞察与局限性分析。
---
...
**[Every Sam Drop Counts Embracing Semantic Priors For Multi-Modality Image Fusion ](every_sam_drop_counts_embracing_semantic_priors_for_multi-modality_image_fusion_.md)**
...
**[Florence-Vl Enhancing Vision-Language Models With Generative Vision Encoder And ](florence-vl_enhancing_vision-language_models_with_generative_vision_encoder_and_.md)**
...
**[Homesafe-Bench Evaluating Vision-Language Models On Unsafe Action Detection For ](homesafe-bench_evaluating_vision-language_models_on_unsafe_action_detection_for_.md)**
...
**[Insight-V Exploring Long-Chain Visual Reasoning With Multimodal Large Language M](insight-v_exploring_long-chain_visual_reasoning_with_multimodal_large_language_m.md)**
...
**[Its A Blind Match Towards Vision-Language Correspondence Without Parallel Data](its_a_blind_match_towards_vision-language_correspondence_without_parallel_data.md)**
...
**[Marten Visual Question Answering With Mask Generation For Multi-Modal Document U](marten_visual_question_answering_with_mask_generation_for_multi-modal_document_u.md)**
...
**[Mimo A Medical Vision Language Model With Visual Referring Multimodal Input And ](mimo_a_medical_vision_language_model_with_visual_referring_multimodal_input_and_.md)**
...
**[Molmo And Pixmo Open Weights And Open Data For State-Of-The-Art Vision-Language ](molmo_and_pixmo_open_weights_and_open_data_for_state-of-the-art_vision-language_.md)**
...
**[Multi-Layer Visual Feature Fusion In Multimodal Llms Methods Analysis And Best P](multi-layer_visual_feature_fusion_in_multimodal_llms_methods_analysis_and_best_p.md)**
...
**[Opening A Comprehensive Benchmark For Judging Open-Ended Interleaved Image-Text ](opening_a_comprehensive_benchmark_for_judging_open-ended_interleaved_image-text_.md)**
...
**[Optimus-2 Multimodal Minecraft Agent With Goal-Observation-Action Conditioned Po](optimus-2_multimodal_minecraft_agent_with_goal-observation-action_conditioned_po.md)**
...
**[Parc A Quantitative Framework Uncovering The Symmetries Within Vision Language M](parc_a_quantitative_framework_uncovering_the_symmetries_within_vision_language_m.md)**
...
**[Playing The Fool Jailbreaking Llms And Multimodal Llms With Out-Of-Distribution ](playing_the_fool_jailbreaking_llms_and_multimodal_llms_with_out-of-distribution_.md)**
...
**[Rethinking Vision-Language Model In Face Forensics Multi-Modal Interpretable For](rethinking_vision-language_model_in_face_forensics_multi-modal_interpretable_for.md)**
...
**[Revisionllm Recursive Vision-Language Model For Temporal Grounding In Hour-Long ](revisionllm_recursive_vision-language_model_for_temporal_grounding_in_hour-long_.md)**
...
**[Robospatial Teaching Spatial Understanding To 2D And 3D Vision-Language Models F](robospatial_teaching_spatial_understanding_to_2d_and_3d_vision-language_models_f.md)**
...
**[Single Domain Generalization For Few-Shot Counting Via Universal Representation ](single_domain_generalization_for_few-shot_counting_via_universal_representation_.md)**
...
**[Skip Tuning Pre-Trained Vision-Language Models Are Effective And Efficient Adapt](skip_tuning_pre-trained_vision-language_models_are_effective_and_efficient_adapt.md)**
...
**[Spa-Vl A Comprehensive Safety Preference Alignment Dataset For Vision Language M](spa-vl_a_comprehensive_safety_preference_alignment_dataset_for_vision_language_m.md)**
...
**[Stealthy Backdoor Attack In Self-Supervised Learning Vision Encoders For Large V](stealthy_backdoor_attack_in_self-supervised_learning_vision_encoders_for_large_v.md)**

:   首次揭示SSL视觉编码器对LVLM的后门安全威胁，提出BadVision——通过双层触发器优化和触发器聚焦后门学习机制，仅篡改视觉编码器即可使下游LVLM产生自由文本形式的视觉幻觉（ASR>99%），同时绕过SOTA检测方法。

**[Steering Away From Harm An Adaptive Approach To Defending Vision Language Model ](steering_away_from_harm_an_adaptive_approach_to_defending_vision_language_model_.md)**
...
**[Sting-Bee Towards Vision-Language Model For Real-World X-Ray Baggage Security In](sting-bee_towards_vision-language_model_for_real-world_x-ray_baggage_security_in.md)**
...
**[Stop Learning It All To Mitigate Visual Hallucination Focus On The Hallucination](stop_learning_it_all_to_mitigate_visual_hallucination_focus_on_the_hallucination.md)**
...
**[Svlta Benchmarking Vision-Language Temporal Alignment Via Synthetic Video Situat](svlta_benchmarking_vision-language_temporal_alignment_via_synthetic_video_situat.md)**
...
**[Tapt Test-Time Adversarial Prompt Tuning For Robust Inference In Vision-Language](tapt_test-time_adversarial_prompt_tuning_for_robust_inference_in_vision-language.md)**
...
**[Teaching Large Language Models To Regress Accurate Image Quality Scores Using Sc](teaching_large_language_models_to_regress_accurate_image_quality_scores_using_sc.md)**
...
**[Thinking In Space How Multimodal Large Language Models See Remember And Recall S](thinking_in_space_how_multimodal_large_language_models_see_remember_and_recall_s.md)**
...
**[Towards Zero-Shot Anomaly Detection And Reasoning With Multimodal Large Language](towards_zero-shot_anomaly_detection_and_reasoning_with_multimodal_large_language.md)**
...
**[Upme An Unsupervised Peer Review Framework For Multimodal Large Language Model E](upme_an_unsupervised_peer_review_framework_for_multimodal_large_language_model_e.md)**
...
**[Vlsi Verbalized Layers-To-Interactions From Large To Small Vision Language Model](vlsi_verbalized_layers-to-interactions_from_large_to_small_vision_language_model.md)**
...
**[Whats In The Image A Deep-Dive Into The Vision Of Vision Language Models](whats_in_the_image_a_deep-dive_into_the_vision_of_vision_language_models.md)**
...
**[Your Large Vision-Language Model Only Needs A Few Attention Heads For Visual Gro](your_large_vision-language_model_only_needs_a_few_attention_heads_for_visual_gro.md)**
