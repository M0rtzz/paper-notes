...
description: >-
  [CVPR 2025][AI安全][图神经网络] 将 Lyapunov 稳定性理论（整数阶和分数阶）与图神经流集成，通过可学习 Lyapunov 函数和投影机制将 GNN 特征动态约束在稳定空间中，首次为图神经流提供可证明的对抗鲁棒性保证，且与对抗训练正交可叠加。 领域现状 领域现状：领域现状：基于动力系统的 GNN（如 G…
tags:
  - "CVPR 2025"
  - "AI安全"
  - "图神经网络"
