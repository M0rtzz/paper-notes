...
description: >-
  [CVPR 2025][3D talking head] 提出 InsTaG 框架，通过 Identity-Free Pre-training 从多人视频中学习通用运动先验，再通过 Motion-Aligned Adaptation 从仅 5 秒视频快速适配高质量个性化 3D 说话人头像，兼具实时推理和快速适配。
tags:
  - CVPR 2025
  - 3D talking head
...
- **做什么**: 从多人长视频中提取通用运动先验，存入共享的 Universal Motion Field (UMF)。
...
- **做什么**: 利用几何估计器提供深度和法线先验，正则化 3DGS 在少视角下的几何退化。
