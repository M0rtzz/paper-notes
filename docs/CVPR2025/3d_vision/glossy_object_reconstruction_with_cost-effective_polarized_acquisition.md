...
description: >-
  [CVPR 2025][3D视觉][光泽物体重建] 提出一种低成本偏振辅助3D重建方法，仅需在普通RGB相机前加一块线性偏振片，每视角拍摄一张偏振图像（无需校准偏振角），通过神经隐式场端到端优化偏振渲染损失来恢复光泽物体的高保真几何和材质分解。 1. 领域现状：基于图像的3D重建方法大多假设Lambertian反射模型…
tags:
  - "CVPR 2025"
  - "3D视觉"
  - "光泽物体重建"
