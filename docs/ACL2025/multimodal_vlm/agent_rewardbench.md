...
description: >-
  [ACL 2025][多模态][奖励模型] Agent-RewardBench 提出了首个面向多模态 Agent 的奖励建模评测基准，覆盖感知/规划/安全 3 个维度、7 个真实场景、1136 个高质量样本，实验发现即使 GPT-4o 也仅达 61.4% 准确率，揭示了 Agent 奖励建模的巨大挑战。
tags:
  - ACL 2025
  - 多模态
  - 奖励模型
...
2. **步骤级奖励评估 (Step-level Reward)**:
    ...
    - 功能：在 Agent 每个中间步骤上采样正负回答，评估奖励模型对单步的判断能力
