...
description: >-
  [ACL 2025][多语言/翻译][机器翻译评估] 本文针对低资源语言的机器翻译评估困境，提出了一套不依赖高质量参考翻译和大规模标注数据的可访问评估框架，使得资源匮乏的语言可以有效评估翻译质量。 领域现状：机器翻译（MT）质量评估是 NLP 的核心问题。当前主流评估方法分为两大类：基于参考的指标（如 BLEU、COMET）…
tags:
  - "ACL 2025"
  - "多语言/翻译"
  - "机器翻译评估"
