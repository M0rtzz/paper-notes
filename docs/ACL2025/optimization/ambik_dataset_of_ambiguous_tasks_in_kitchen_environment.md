...
description: >-
  [ACL 2025][优化/理论][歧义检测] 提出 AmbiK，一个专门用于厨房环境中歧义指令检测的纯文本数据集，包含 1000 对歧义/非歧义指令，按三种歧义类型（用户偏好/常识/安全）分类标注，并评估了多种基于 conformal prediction 的歧义检测方法，发现现有方法在该基准上表现很差。
tags:
  - "ACL 2025"
  - "优化/理论"
  - "歧义检测"
...
- [\[ACL 2025\] ScaleBiO: Scalable Bilevel Optimization for LLM Data Reweighting](scalebio_bilevel_data_reweighting.md)
