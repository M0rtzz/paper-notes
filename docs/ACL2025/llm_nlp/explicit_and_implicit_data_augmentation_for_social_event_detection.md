...
description: >-
  [LLM 其他] 本文提出SED-Aug，一个结合显式（LLM文本增强）和隐式（特征空间扰动）的双重数据增强框架用于社交事件检测，在Twitter2012和Twitter2018上分别超越最优基线17.67%和15.57%的平均F1。 - 社交事件检测（SED）：从社交媒体中识别和分类重要事件，是危机管理、舆情分析和金融市场…
tags:
  - "LLM 其他"
---
