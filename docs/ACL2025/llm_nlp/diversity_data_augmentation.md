...
description: >-
  [ACL 2025][LLM 其他][数据增强] 提出 DoAug 框架，通过 SFT+DPO 微调 LLM 释义器并结合核心集选择与多样性采样，在保持语义一致性的同时显著提升增强数据集的多样性，在 12 个数据集上平均性能提升 10.52%，超出次优基线 3.76 个百分点。 高质量数据集三要素：作者指出训练 NLP 模型…
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "数据增强"
