...
description: >-
  [ACL 2025][LLM 其他][自然语言博弈] 本文研究 LLM 智能体在自然语言交互环境中的合作与竞争行为，通过设计多人博弈场景，分析语言策略（如说服、欺骗、协商）如何影响博弈结果，揭示了 LLM 在社会交互中的策略涌现能力和局限性。 领域现状：随着 LLM 能力的提升，将 AI 智能体部署在社会交互场景中的需求日益…
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "自然语言博弈"
