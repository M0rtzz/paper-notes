...
description: >-
  [ACL 2025][LLM 其他][模型合并] 提出Hi-Merging，一种层级迭代式无训练模型合并：方法，通过模型级和层级的剪枝与缩放操作，结合贡献度分析来识别和解决参数冲突，将不同任务/语言的专用LLM合并为统一的多任务模型，在大多数场景下超越混合数据微调的基线。 随着LLaMA、Qwen等开源大模型的发布…
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "模型合并"
