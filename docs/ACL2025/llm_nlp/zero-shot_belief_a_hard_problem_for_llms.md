...
description: >-
  ACL 2025 论文解读：提出统一式和混合式两种零样本框架用于信念预测任务，混合方法结合 DeBERTa 事件检测器和 LLM 信念标注，在 FactBank 上刷新 SOTA（Full F1 72.0%），首次报告嵌套信念指标（Nested F1 仅 25.3%），揭示 LLM 在嵌套信念推理上的显著短板。
tags:
  - ACL 2025
  - LLM/NLP
  - 信念预测
