...
description: >-
  [ACL 2025][LLM 其他][主题提取评估] 提出 T5Score 方法论，将 LLM 生成的自由文本主题集(FT-topics)的质量分解为五个可量化维度（可解释性、主题覆盖、文档覆盖、非重叠性、内部排序），通过简单标注任务实现高标注者一致性，并验证 LLM 可作为自动评估器替代人工。 领域现状： 随着 LLM 的…
tags:
  - "ACL 2025"
  - "LLM 其他"
  - "主题提取评估"
