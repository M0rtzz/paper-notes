---
title: >-
  [论文解读] LADM: Long-context Training Data Selection with Attention-based Dependency Measurement
description: >-
  [ACL 2025][LLM效率][长上下文] 提出 LADM 框架，利用注意力机制的内在检索能力来度量长上下文数据中的跨 span 依赖关系，从大规模预训练语料中高效筛选高质量长上下文训练数据，仅用 1B token 持续预训练即可显著提升多种 LLM 的长上下文能力。
tags:
  - ACL 2025
  - LLM效率
  - 长上下文
...
**关键词**: 长上下文, 数据选择, 注意力机制, dependency measurement, continual pre-training
