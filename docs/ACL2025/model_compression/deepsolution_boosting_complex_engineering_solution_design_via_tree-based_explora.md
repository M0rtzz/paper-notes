...
description: >-
  [ACL 2025][模型压缩][RAG] 提出面向复杂工程方案设计的新基准 SolutionBench 和新系统 SolutionRAG，通过树搜索探索+双视角思维（设计-审查交替）在 RAG 框架下逐步生成满足多约束的可靠工程方案，在 8 个工程领域达到 SOTA。 - 任务定义： 复杂工程方案设计要求系统针对含多个现实…
tags:
  - "ACL 2025"
  - "模型压缩"
  - "RAG"
