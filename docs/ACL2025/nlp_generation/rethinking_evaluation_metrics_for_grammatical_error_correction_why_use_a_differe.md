...
**本文要解决什么？** 系统性地识别和弥合人工评估与自动评估在聚合流程上的差距：将所有自动评估指标统一改用与人工评估相同的 TrueSkill 聚合方式，并在标准元评估基准 SEEDA 上验证这一改变的效果。
...
**核心 idea 一句话**：在 GEC 自动评估中使用与人工评估相同的 TrueSkill 聚合方式替代传统的分数平均，从而在不修改指标本身的情况下显著提升排名与人工评估的一致性。
