...
description: >-
  [ACL 2025][文本生成][摘要片段生成] 本文提出了一种面向搜索引擎的抽象化片段生成方法，通过查询感知的摘要生成技术，为搜索结果页面生成比传统抽取式片段更简洁、信息量更大的文本摘要，显著提升用户搜索体验。 领域现状：搜索引擎在展示搜索结果时通常会为每个网页生成一段文本片段（snippet），帮助用户快速判断网页内容是…
tags:
  - "ACL 2025"
  - "文本生成"
  - "摘要片段生成"
