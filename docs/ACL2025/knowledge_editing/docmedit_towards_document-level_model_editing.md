...
description: >-
  [ACL 2025][知识编辑][模型编辑] 首次提出文档级模型编辑任务，构建包含 37,990 条数据、105,652 个编辑事实的 DocMEdit 基准，揭示现有编辑方法在长上下文、多事实并行编辑场景下的严重不足。 模型编辑旨在以最小代价纠正 LLM 中的错误或过时知识。现有数据集（ZsRE、CounterFact、M…
tags:
  - "ACL 2025"
  - "知识编辑"
  - "模型编辑"
