...
description: >-
  [ACL 2025][知识编辑][复杂问答] 提出CompKe基准——包含11,924个复杂问题——用于评估知识编辑方法在涉及一对多关系、逻辑操作（交集/并集）和条件确认：的复杂推理场景下的表现，揭示现有方法在复杂问答上的显著不足。 领域现状：知识编辑(Knowledge Editing, KE)旨在高效更新LLM的知识而不…
tags:
  - "ACL 2025"
  - "知识编辑"
  - "复杂问答"
