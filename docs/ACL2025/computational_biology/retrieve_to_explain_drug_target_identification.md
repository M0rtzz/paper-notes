...
description: >-
  [ACL 2025][计算生物][检索增强预测] 提出 R2E (Retrieve to Explain)，一种基于检索的架构，通过从文献语料库中检索证据来评分和排序所有候选答案，并利用 Shapley 值将预测忠实地归因到支撑证据，在药物靶点识别任务上超越了遗传学基线和 GPT-4 基线。 在高风险科学发现场景（如药物靶点…
tags:
  - "ACL 2025"
  - "计算生物"
  - "检索增强预测"
