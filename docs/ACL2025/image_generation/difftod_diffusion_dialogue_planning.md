...
description: >-
  [ACL 2025][图像生成][对话规划] DiffTOD 将对话规划建模为轨迹生成问题，利用掩码扩散语言模型实现非顺序对话规划，并设计三种引导机制（词级/语义级/搜索级）灵活控制对话朝目标推进，在谈判/推荐/闲聊三种场景上显著超越基线。 领域现状：目标导向对话（TOD）系统需要战略性地引导对话朝特定目标推进（如达成交易、…
tags:
  - "ACL 2025"
  - "图像生成"
  - "对话规划"
