...
description: >-
  [ACL 2025][LLM对齐][谈判智能体] 本文受人类认知双过程理论启发，提出双心智谈判智能体框架（DMNA），将直觉模块（快速策略规划，基于 MCTS+DPO 训练）和审慎模块（慢速表达优化，基于多面反思机制）相结合，在谈判任务上取得了最优性能。 领域现状：谈判是一种特殊的对话场景，要求智能体不仅能生成流畅的自然语言…
tags:
  - "ACL 2025"
  - "LLM对齐"
  - "谈判智能体"
