...
description: >-
  [ACL 2025][运动指导生成] 提出 CoachMe，通过对比学习者动作与参考动作的差异（时间+物理两个维度），自动生成运动特异性的教练指导文本，在花样滑冰和拳击上分别超过 GPT-4o 31.6% 和 58.3%（G-Eval）。 领域现状：视觉语言模型在动作描述（motion caption）方面取得进展…
tags:
  - "ACL 2025"
  - "运动指导生成"
  - "姿态分析"
