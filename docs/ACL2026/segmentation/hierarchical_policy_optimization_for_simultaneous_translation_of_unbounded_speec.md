...
**代码**: https://github.com/owaski/HPO  
**领域**: NLP理解 / 语音翻译  
...
- [Breaking the Stealth-Potency Trade-off in Clean-Image Backdoors with Generative Trigger Optimization](../../AAAI2026/segmentation/breaking_the_stealth-potency_trade-off_in_clean-image_backdoors_with_generative_.md)
