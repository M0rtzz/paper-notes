...
description: >-
  [ACL2026][多智能体][多智能体生成] 本文提出 MAFIG，一个用多智能体协作、特征级评估器和迭代修订来生成阅读理解选择题的框架，相比单轮提示能显著提高题目对词汇、篇幅、句长、推理复杂度、事实性和选项中立性等约束的满足率，并带来更稳定的难度递增。 领域现状：阅读理解题在语言教学、能力测评和机考系统中都很核心…
tags:
  - "ACL2026"
  - "多智能体"
  - "多智能体生成"
