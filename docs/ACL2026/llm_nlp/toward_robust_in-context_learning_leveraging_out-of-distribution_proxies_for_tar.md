...
description: >-
  [ACL 2026][LLM 其他][上下文学习] 通过构造源域和目标域的双代理并计算其困惑度差值作为 OOD 得分，结合马哈拉诺比斯距离约束演示多样性，在无法获取目标域样本的条件下，从源域中精准筛选与目标域分布对齐的演示样本，增强 LLM 的上下文学习鲁棒性。 领域现状：大语言模型通过上下文学习（ICL）范式已展现出强大的…
tags:
  - "ACL 2026"
  - "LLM 其他"
  - "上下文学习"
