...
description: >-
  [ACL 2026][机器人][视觉语言导航] 本文针对具身代理（特别是视觉语言导航 VLN 代理）的多层次能力失败问题，提出 CanTest 框架，通过能力导向的测试预言机与失败归因机制，精准定位导致任务失败的具体能力缺陷（感知/记忆/规划/决策），比现有方法发现的失败案例多 23–34%。 领域现状：具身代理在安全关键应…
tags:
  - "ACL 2026"
  - "机器人"
  - "视觉语言导航"
