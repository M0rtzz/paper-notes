...
description: >-
  [ACL 2026][LLM推理][工具内化] 本文提出 TInR-U 框架，通过将工具知识内化到 LLM 参数中（而非依赖外部文档），实现高效且可靠的工具辅助推理，在域内和域外测试中均优于现有方法。 领域现状：工具集成推理（TIR）已成为扩展 LLM 能力的主流方向，通过让模型在推理过程中调用外部工具来解决知识更新、实时查…
tags:
  - "ACL 2026"
  - "LLM推理"
  - "工具内化"
